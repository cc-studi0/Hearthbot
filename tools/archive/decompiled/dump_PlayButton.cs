...
public class PlayButton : PegUIElement
{
	...
	public UberText m_playButtonTertiaryText;
	...
	private const string PLAY_BUTTON_DISABLED_WITH_VISIBLE_LABEL_STATE = "DISABLED_WITH_LABEL";
	...
	public void Disable(bool keepLabelTextVisible = false)
	{
		...
		if (m_visualController != null)
		{
			if (!keepLabelTextVisible)
			{
				m_visualController.SetState("DISABLED");
			}
			else
			{
				m_visualController.SetState("DISABLED_WITH_LABEL");
			}
		}
	}
	...
	public void SetTertiaryText(string newText)
	{
		if (m_playButtonTertiaryText != null)
		{
			m_playButtonTertiaryText.Text = newText;
		}
	}
}
